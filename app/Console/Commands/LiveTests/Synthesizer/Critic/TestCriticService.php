...
class TestCriticService extends Command
{
    protected $signature = 'live-test:synthesizer:test-critic-service
                            ...
                            {--purpose= : Critic purpose (voice, structure, clarity, concision, fingerprint, evidence, general)}
    ...
    private function resolveCriticsFromManager(): ?array
    {
        ...
        $scope = $this->choice(
            ...
            [
                'Single purpose',
                'All purposes (voice, structure, clarity, concision, fingerprint, evidence, general)',
            ],
            1
        );
