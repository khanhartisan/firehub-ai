...
{
    public function setEngagementStrategy(string $strategy, ?float $weight = null): static
    {
        return $this->set(
            'engagement_strategy',
    ...
    public function setMaxHedgingRatio(string|float $maxHedgingRatio, ?float $weight = null): static
    {
        return $this->set(
            'max_hedging_ratio',
    ...
    public function setFormattingQuirks(array $quirks, ?float $weight = null): static
    {
        return $this->set(
            'formatting_quirks',
