    ...
    public static function openai(): array
    {
        return [
            ...
            'critics' => [
                ...
                CriticProfileEntry::entry('openai', 'concision', 5, ['max_rectification_rounds' => 5]),
    ...
    public static function openaiCompatible(): array
    {
        return [
            ...
            'critics' => [
                ...
                CriticProfileEntry::entry('openai_compatible', 'concision', 5, ['max_rectification_rounds' => 5]),
