    ...
    public static function basic(): array
    {
        return [
            ...
            'critics' => [
                ...
                CriticProfileEntry::entry('basic', 'hallucination', 6),
                CriticProfileEntry::entry('basic', 'general', 7),
            ],
            'writer' => 'basic',
            'tagger' => 'basic',
            'illustration' => [
    ...
    public static function openai(): array
    {
        return [
            ...
            'critics' => [
                ...
                CriticProfileEntry::entry('openai', 'clarity', 2),
                ...
                CriticProfileEntry::entry('openai', 'hallucination', 6),
                CriticProfileEntry::entry('openai', 'structure', 7, ['max_rectification_rounds' => 5]),
            ],
            'writer' => 'openai',
            'tagger' => 'openai',
            'illustration' => [
    ...
    public static function openaiCompatible(): array
    {
        return [
            ...
            'critics' => [
                ...
                CriticProfileEntry::entry('openai_compatible', 'evidence', 3),
                CriticProfileEntry::entry('openai_compatible', 'concision', 4),
                CriticProfileEntry::entry('openai_compatible', 'fingerprint', 5),
                CriticProfileEntry::entry('openai_compatible', 'hallucination', 6),
                CriticProfileEntry::entry('openai_compatible', 'structure', 7),
            ],
