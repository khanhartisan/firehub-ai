...
final class SynthesizerDriverProfiles
{
    ...
    public static function openai(): array
    {
        return [
            ...
            'editor' => 'openai',
            'critics' => [
                CriticProfileEntry::entry('openai', 'voice', 0),
                CriticProfileEntry::entry('openai', 'structure', 1),
                CriticProfileEntry::entry('openai', 'clarity', 2, ['max_rectification_rounds' => 2]),
                CriticProfileEntry::entry('openai', 'concision', 3),
                CriticProfileEntry::entry('openai', 'evidence', 4),
                CriticProfileEntry::entry('openai', 'fingerprint', 5),
                CriticProfileEntry::entry('openai', 'general', 6),
            ],
            'writer' => 'openai',
            'illustration' => [
                'director' => 'openai',
    ...
    public static function openaiCompatible(): array
    {
        return [
            ...
            'critics' => [
                CriticProfileEntry::entry('openai_compatible', 'voice', 0),
                CriticProfileEntry::entry('openai_compatible', 'structure', 1),
                CriticProfileEntry::entry('openai_compatible', 'clarity', 2),
                CriticProfileEntry::entry('openai_compatible', 'concision', 3),
                CriticProfileEntry::entry('openai_compatible', 'fingerprint', 4),
                CriticProfileEntry::entry('openai_compatible', 'evidence', 5),
                CriticProfileEntry::entry('openai_compatible', 'general', 6),
            ],
